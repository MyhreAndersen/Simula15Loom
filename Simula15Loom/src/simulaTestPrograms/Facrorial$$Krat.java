...
public final class Facrorial$$Krat extends PROC$ {
    ...
    public Facrorial$$Krat setPar(Object param) {
        //Util.BREAK("CALL Facrorial$$Krat.setPar: param="+param+", qual="+param.getClass().getSimpleName()+", npar="+$nParLeft+", staticLink="+SL$);
        try {
            switch($nParLeft--) {
    ...
    public Facrorial$$Krat(RTObject$ SL$) {
        super(SL$,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public Facrorial$$Krat(RTObject$ SL$,TXT$ sp$s,TXT$ sp$t) {
        super(SL$);
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("Facrorial.sim","Procedure Krat",1,3,15,4,53,5,57,7,61,8,64,9,67,10,71,12,75,13,78,14,81,15,84,16,87,17,90,18,93,19,99,21,101,23,104,24,108,25,116,28,121,29);
} // End of Procedure
