...
public class Ranking {
	...
	Ranking(String name) { this.name=name; }
	public Ranking() { this.name=null; }
...
//	};
    ...
    public static Ranking RANK_PRED (Ranking ins) {
        Ranking prd=null; // Return value
        if(ins.rl == ins) {
            prd = null;
        } else if(ins.rl != null) {
            prd = ins.rl;
    ...
    public static Ranking RANK_SUC (Ranking ins) {
        Ranking suc=null; // Return value
    ...
    public static void RANK_CLEAR (Ranking head) {
    ...
    public static boolean RANK_EMPTY (Ranking head) {
    ...
    public static Ranking RANK_FIRST (Ranking head) {
        Ranking first=null; // Return value
    ...
    public static Ranking RANK_LAST (Ranking head) {
        Ranking last=null; // Return value
    ...
    public static void RANK_FOLLOW (Ranking ins,Ranking prd) {
    ...
    public static void RANK_OUT (Ranking ins) {
    ...
    public static void RANK_INTO (Ranking ins,Ranking head,double rnk) {
    ...
    public static void RANK_PRECEDE (Ranking ins,Ranking suc) {
    ...
    public static void RANK_PRIOR (Ranking ins,Ranking head,double rnk) {
    ...
    public static String edit(Ranking sqs) {
    	StringBuilder s=new StringBuilder();
    	Ranking x=RANK_FIRST(sqs);
    	do s.append(x).append(", ");
	...
	public static void main(String[] args) {
		...
		RANK_INTO(new Ranking(),sqs,34);
		RANK_INTO(new Ranking(),sqs,14);
		RANK_INTO(new Ranking(),sqs,36);
		RANK_INTO(new Ranking(),sqs,3);
		RANK_PRIOR(new Ranking("PRIOR"),sqs,34);
		RANK_INTO(new Ranking("NORMAL"),sqs,34);
